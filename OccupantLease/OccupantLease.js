...
const formUnderline=document.querySelectorAll('.formUnderline')
  ...
  let currentActive=parseInt(greetingValue)
	...
	++currentActive
    window.location.href=`/Submit/submit.html?value=${currentActive}`
...
// --------------------------------------------------------------------
// --------------------------------------------------------------------
    const occupantUpdate = document.getElementById("update-occupant");
	const occupantList = document.querySelector("#occupantUpgrade");
	let updateCount=2

  occupantUpdate.addEventListener('click',()=>{
	const subTitle = document.createElement('div');
	subTitle.classList.add('subTitle')
	occupantList.appendChild(subTitle)

    let h4=document.createElement('h4');
	h4.innerText=`OCCUPANT ${++updateCount}`
	...
	firstoccupantBackground.classList.add('second-occupantBackground')
